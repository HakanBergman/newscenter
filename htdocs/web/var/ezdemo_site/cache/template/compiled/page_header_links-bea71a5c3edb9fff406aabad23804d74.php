...
$oldSetArray_70a47d4e849f5a56d9e7a8952211876f = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= ' title="Sitemap">Sitemap</a></li>
    ';
// if begins
unset( $if_cond );
unset( $if_cond1 );
...
if ( $if_cond )
{
$text .= '    <li id="shoppingbasket"><a href="/index.php/shop/basket" title="Kundvagn">Kundvagn</a></li>
   ';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    <li id="myprofile"><a href="/index.php/user/edit" title="My profile">My profile</a></li>
    <li id="logout"><a href="/index.php/user/logout" title="Logout">Logout ( ';
unset( $var );
unset( $var1 );
unset( $var1 );
...
if ( $if_cond )
{
$text .= '    <li id="registeruser"><a href="/index.php/user/register" title="Registrera">Registrera</a></li>
    ';
}
unset( $if_cond );
// if ends
...
$text .= '    <li id="login" class="transition-showed">
        <a href="#login" title="show login form" class="show-login-form">Logga in</a>
        <a href="#" title="hide login form" class="hide-login-form">Logga in</a>
        <form class="login-form span3" action="/index.php/user/login" method="post">
            <fieldset>
                <label>
                    <span class="hidden">Användarnamn</span>
                    <input type="text" name="Login" id="login-username" placeholder="Username">
                </label>
                <label>
                    <span class="hidden">Lösenord</span>
                    <input type="password" name="Password" id="login-password" placeholder="Password">
                </label>
                <div class="clearfix">
                    <a href="/index.php/user/forgotpassword" class="forgot-password">Glömt ditt lösenord?</a>
...
$setArray = $oldSetArray_70a47d4e849f5a56d9e7a8952211876f;
$tpl->Level--;
?>

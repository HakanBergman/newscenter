...
$oldSetArray_061ca85a2718dc00e6e5b1d4dfa2c78b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= ']</span> Systemet kunde inte logga in dig.</h2>
<ul>
    ';
// if begins
unset( $if_cond );
...
$var = strtr( '"%user_login" kan inte logga in då gränsen för antalet misslyckade inloggningar har passerats!', $var3 );
...
$text .= '</li>
         <li>Vänligen kontakta adminsitratören för hemsidan.</li>
    ';
}
else
{
$text .= '         <li>Kontrollera användarnamn och id.</li>
         <li>Alla bokstävermåste anges med rätt skiftläge. </li>
         <li>Försök igen eller kontakta adminsitratören.</li>
    ';
}
unset( $if_cond );
// if ends
...
$var1 = strtr( 'Du har inte behörighet att komma åt <%siteaccess_name>.', $var4 );
...
$var = strtr( 'Användaren kommer inte kunna logga in efter <b>%max_number_failed</b> inloggningsförsök.', $var3 );
unset( $var2, $var3, $var4, $var5 );
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
...
$text .= '    
    ...
    <div class="block">
        <div class="login-input-wrapper">
            ...
            <input class="halfbox" type="text" autofocus="autofocus" size="10" name="Login" id="logintext" placeholder="Användarnamn" tabindex="1" title="Ange ett giltigt användarnamn i detta fält." />
        </div>
    </div>
    ...
    <div class="block">
        <div class="login-input-wrapper">
            ...
            <input class="halfbox" type="password" size="10" name="Password" id="passwordtext" placeholder="Lösenord" tabindex="2" title="Ange ett giltigt lösenord i detta fält." />
        </div>
    </div>
...
{
$text .= '        <div class="block login-text-wrapper">
            <input type="checkbox" name="Cookie" id="id3" /><label for="id3" style="display:inline;">Kom ihåg mig</label>
        </div>
    ';
}
unset( $if_cond );
...
<div class="block">
    <div class="login-input-wrapper">
        <input class="defaultbutton" type="submit" id="loginbutton" name="LoginButton" value="Logga in" tabindex="3" title="Vänligen fyll i en fungerande användarnamn och lösenordskombination i fältet ovan och klicka på "Logga in"." />
    </div>
    <div class="login-text-wrapper">
        eller
        <br/>
        <a href="/index.php/user/register">Register new account</a>
    </div>
</div>
</div></div>
</div>
...
$setArray = $oldSetArray_061ca85a2718dc00e6e5b1d4dfa2c78b;
$tpl->Level--;
?>

...
$oldSetArray_6818b57a929c926d58d01c83e67d3e5a = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$var1 = strtr( '%sitetitle startsida', $var4 );
...
$text .= '" + document.location.search;
    ...
    printNode.title = "Utskriftsvänlig version";
...
$setArray = $oldSetArray_6818b57a929c926d58d01c83e67d3e5a;
$tpl->Level--;
?>

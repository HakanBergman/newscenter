...
$TranslationRoot = array (
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Sub items [%children_count]',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Show 10 items per page.',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Show 50 items per page.',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Show 25 items per page.',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Use the priority fields to control the order in which the items appear. You can use both positive and negative integers. Click the "Update priorities" button to apply the changes.',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'You are not allowed to update the priorities because you do not have permission to edit <%node_name>.',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'The current item does not contain any sub items.',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Apply changes to the priorities of the items in the list above.',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'You cannot update the priorities because you do not have permission to edit the current item or because a non-priority sorting method is used.',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'You cannot set the sorting method for the current location because you do not have permission to edit the current item.',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Use these controls to set the sorting method for the sub items of the current location.',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Invalid or missing parameter: %parameter',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Use these checkboxes to select items for removal. Click the "Remove selected" button to  remove the selected items.',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'You do not have permission to remove this item.',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Remove the selected items from the list above.',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'You do not have permission to remove any of the items from the list above.',

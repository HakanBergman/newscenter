...
<html lang="{$site.http_equiv.Content-language|wash}">
	...
	<body class="{$#company.data_map.background_color.data_text} {$sitesettings.0.data_map.background_color.data_text} {$#company.data_map.font_family_class.data_text}">
	<div id="fb-root"></div>

	...
	<nav class="navbar navbar-fixed-top min-height-none bg-white thumbnail">
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 no-padding no-margin container-padding-left-2">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-margin no-padding container-margin-top-108 left-none bg-white absolute min-height-8-em" id="admin_sidebar_dhc">

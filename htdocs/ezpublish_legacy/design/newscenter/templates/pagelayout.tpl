				...
				<div class="container">
                    <footer class="{$menusettings.0.data_map.link_color.data_text} {$menusettings.0.data_map.link_active_color.data_text} {$menusettings.0.data_map.link_hover_color.data_text} {$sitesettings.0.data_map.text_color_footer.data_text} container-padding-top">
                        ...
                        <div class="col-lg-12 nav-padding-bottom-4 {$#company.data_map.text_color_footer.data_text}">
							...
							<div class="col-lg-4">{$sitesettings.0.data_map.address.data_text}, {$sitesettings.0.data_map.zipcode.data_text} {$sitesettings.0.data_map.city.data_text}</div>
							<div class="col-lg-3">Tel:</span> <a href="tel:{$sitesettings.0.data_map.phone.data_text}">{$sitesettings.0.data_map.phone.data_text}</a></div>
							<div class="col-lg-4">E-postadress:</span> <a href="mailto:{$sitesettings.0.data_map.email.data_text}">{$sitesettings.0.data_map.email.data_text}</a></div>
							<div class="col-lg-1"><a href="/user/login" class="font-size-10-px container-padding-left"><span class="glyphicon glyphicon-lock"></span></a></div>
                        </div>
                    </footer>
				</div>
			</div>

                    ...
                    {foreach $grandchildren as $grandchild}
                      <li>
                        {* <a href="{$granchild.url|ezurl('no', 'full')}" title="{$granchild.name|wash()}"> *}
                          <div class="col-lg-12 no-margin no-padding">{$grandchild.data_map.name.data_text|wash()} <img src="/{$grandchild.data_map.image.content.original.full_path}" alt="{$grandchild.name|wash()}"/></div>

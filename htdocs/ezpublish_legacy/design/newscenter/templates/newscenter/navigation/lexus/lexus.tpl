                ...
                <ul class="cbp-hssubmenu bg-white navigation-box container-margin-top-1-px container-padding-top container-padding-bottom">                 
                  ...
                  {def $grandchildren = fetch('content', 'list', hash('parent_node_id', $submenu.node_id))}
                    {foreach $grandchildren as $grandchild}
                      <li>
                        <a href="{$grandchild.url|ezurl('no', 'full')}" title="{$grandchild.name|wash()}" class="line-height-1-em text-align-left">
                          <div class="col-lg-4 no-margin no-padding">
                            ...
                            <div class="font-size-14-px font-weight-normal">{$grandchild.data_map.extra_attribute_one.data_text}</div>
                          </div>

        ...
        <div class="container">
          <div class="navbar yamm no-margin no-padding">
            <ul class="nav navbar-nav no-padding">              
              ...
              <li class="{if $subitems|count()}dropdown yamm-fw {/if}no-padding no-margin float-left {$menusettings.0.data_map.link_color.data_text} {$#company.data_map.link_color_menu_active.data_text} {$#company.data_map.link_color_menu_mouseover.data_text}">                  

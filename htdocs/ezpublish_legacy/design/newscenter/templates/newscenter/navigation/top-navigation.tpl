...
{def $menu_items = fetch('content', 'list', hash('parent_node_id', $#company.node_id, 'class_filter_type', 'include', 'class_filter_array', array('contact_list', 'news_list', 'website', 'link', 'product_catalogue', 'product_country'), 'sort_by', array('priority', true()) ))}
  {if $menu_items}
    <nav role="navigation">
        ...
        <div class="container">
          <div class="navbar yamm no-margin no-padding navigation-box">
            <ul class="nav navbar-nav no-padding">
              ...
              {def $subitems = fetch('content', 'list', hash('parent_node_id', $item.node_id, 'class_filter_type', 'include', 'class_filter_array', array('news_category', 'product_category'), 'sort_by', array('name', true()) ))}

	<div class="row widget-products">
			<article>
                ...
                <form method="post" action="/shop/basket" class="form_number_{$product.id}">
                  ...
                  <div class="col-lg-2 no-margin no-padding"><input type="text" class="form-control quantity_number_{$product.id}" placeholder="1" value="1" name="quantity" /></div>

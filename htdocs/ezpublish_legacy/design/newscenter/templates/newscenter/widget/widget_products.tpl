	<div class="row widget-products">
			<article>
                ...
                <form method="post" action="/shop/basket" class="form_number_{$product.object.id}">
                  ...
                  <div class="col-lg-6 col-md-6 col-md-6 col-xs-6"><button type="submit" class="btn btn-primary glyphicon glyphicon-plus" name="ActionAddToBasket" product-id="{$product.object.id}" product-price="{$product.object.price_inc_vat}"></button></div>
                </form>
              </div>
						{/foreach}
					{undef $products}

	...
	<div class="{if $block.data_map.fullscreen.value}container-fluid{else}container{/if}">
		<article>
			<div class="media">
				...
				<img class="img-responsive thumbnail no-margin no-padding" src="/{$block.data_map.image.content.original.full_path}" alt="{$block.data_map.image.content.alternative_text|wash()}">

<nav class="navbar-fixed-top height-100-percent {$block.data_map.overlay_background_color.data_text} {$block.data_map.opacity.data_text}" id="overlay-{$block.contentobject_id}"></nav>
<nav class="navbar-fixed-top height-100-percent no-background" id="overlay-content-{$block.contentobject_id}">
	<div class="container">

...
<nav class="overlay-content navbar-fixed-top height-100-percent no-background hide" id="overlay-content-{$block.contentobject_id}">
	<div class="container">
		<div class="row no-margin no-padding container-padding-left-1 container-padding-right-1">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding container-margin-top-10-percent {$block.data_map.background_color.data_text}">
				<div class="container-padding-left-1 container-padding-right-1 container-padding-top-2 container-padding-bottom-2">
					...
					<div class="container-padding-left-1 container-padding-right-1 font-size-105-em">
						{$block.data_map.body.data_text}
					</div>
					<div class="container-padding-left-1 container-padding-right-1 container-padding-top-2">

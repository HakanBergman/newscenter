<div class="row thumbnail widget-margin-top widget-list-slider">
  <ul class="pgwSlider">
    {if $block.data_map.image_one.has_content}
      <li>
        <img class="min-height-100-percent img-responsive" src="/{$block.data_map.image_one.content.original.full_path}" alt="{$block.data_map.image_one.content.alternative_text}" data-description="{$block.data_map.image_one.content.alternative_text}"></img> 
      </li>
    {/if}
    <li>

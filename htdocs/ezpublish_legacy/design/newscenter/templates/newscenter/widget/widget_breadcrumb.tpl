  ...
  <div class="{$desktop_size} {$tablet_size|explode('lg')|implode('md')} {$phone_size|explode('lg')|implode('sm')} container-padding-top-05 container-padding-left no-margin no-padding">
    <ol class="breadcrumb">

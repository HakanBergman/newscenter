                ...
                <div class="colors hide">
                  <div class="form-group">
                    ...
                    <div class="col-lg-12">
                      ...
                      <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><span class="thumbnail bg-black min-height-1-em min-width-1-em max-width-1-em cursor-pointer" data-color="bg-granate" data-hex="#570900"></span></div>
                      <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><span class="thumbnail bg-black min-height-1-em min-width-1-em max-width-1-em cursor-pointer" data-color="bg-grey" data-hex="#EEE"></span></div>
                      <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><span class="thumbnail bg-black min-height-1-em min-width-1-em max-width-1-em cursor-pointer" data-color="bg-pink" data-hex="#F9DADD"></span></div>
                      <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><span class="thumbnail bg-black min-height-1-em min-width-1-em max-width-1-em cursor-pointer" data-color="bg-tidningen-se" data-hex="#004389"></span></div>
                      <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><span class="thumbnail bg-black min-height-1-em min-width-1-em max-width-1-em cursor-pointer" data-color="bg-dynamite-orange" data-hex="#F5A818"></span></div>
                      <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><span class="thumbnail bg-black min-height-1-em min-width-1-em max-width-1-em cursor-pointer" data-color="bg-dynamite-green" data-hex="#D4D977"></span></div>
                      <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><span class="thumbnail bg-black min-height-1-em min-width-1-em max-width-1-em cursor-pointer" data-color="bg-longdrink-blue" data-hex="#4BC6D1"></span></div>
                      <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><span class="thumbnail bg-black min-height-1-em min-width-1-em max-width-1-em cursor-pointer" data-color="bg-beer-brown" data-hex="#DE910b"></span></div>
                      <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><span class="thumbnail bg-black min-height-1-em min-width-1-em max-width-1-em cursor-pointer" data-color="bg-beige" data-hex="#DECC9E"></span></div>
                      <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><span class="thumbnail bg-black min-height-1-em min-width-1-em max-width-1-em cursor-pointer" data-color="bg-beige-yellow" data-hex="#FFFFD1"></span></div>
                    </div>
                    <div class="col-lg-12">
                      <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><span class="thumbnail bg-black min-height-1-em min-width-1-em max-width-1-em cursor-pointer" data-color="bg-beige-brown" data-hex="#DEDEB4"></span></div>
                    </div>

                ...
                <div class="colors hide">
                  <div class="form-group">
                    ...
                    <div class="col-lg-12">
                      ...
                      <div class="picked-color hide">Vald färg <span class="color"></span>
                    </div>
                      <div class="saved-color hide">{attribute_edit_gui attribute=$object.data_map.background_color}</div>
                    </div>
                  </div>
                </div>

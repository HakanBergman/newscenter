              ...
              <div class="form container-padding-left-2">
                ...
                <div class="colors hide">
                  <div class="form-group">
                    ...
                    <div class="col-lg-1"><span class="thumbnail bg-white border-solid-black min-height-1-em min-width-1-em max-width-1-em"></span></div>
                    <div class="col-lg-1"><span class="thumbnail bg-black min-height-1-em min-width-1-em max-width-1-em"></span></div>

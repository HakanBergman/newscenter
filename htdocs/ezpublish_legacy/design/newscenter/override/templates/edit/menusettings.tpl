                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-12 clear container-padding-top">
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <span class="hover-color thumbnail bg-beer-brown min-height-2-em min-width-2-em max-width-2-em cursor-pointer float-left container-margin-left" data-color="link-color-dark-orange-active" data-hex="#faad41"></span>

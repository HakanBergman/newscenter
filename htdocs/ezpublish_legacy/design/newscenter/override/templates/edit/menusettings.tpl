                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-12 clear">
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                        
                        ...
                        <span class="background-logotype-color thumbnail bg-careit-2 min-height-2-em min-width-2-em max-width-2-em cursor-pointer float-left container-margin-left" data-color="bg-careit-2" data-hex="#666e45"></span>
                    ...
                    <div class="col-lg-12 clear container-padding-top">
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <span class="background-color thumbnail bg-careit-2 min-height-2-em min-width-2-em max-width-2-em cursor-pointer float-left container-margin-left" data-color="bg-careit-2" data-hex="#666e45"></span>

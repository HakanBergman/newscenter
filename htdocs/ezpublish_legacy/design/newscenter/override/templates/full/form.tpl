						...
						<ul class="navbar no-margin no-padding">
							{foreach $questions as $question}
								<div class="col-lg-12 container-margin-top no-margin no-padding">
									...
									<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><input type="radio" name="question_{$question.contentobject_id}" value="1"></div>
									<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><input type="radio" name="question_{$question.contentobject_id}" value="2"></div>
									<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><input type="radio" name="question_{$question.contentobject_id}" value="3"></div>
									<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><input type="radio" name="question_{$question.contentobject_id}" value="4"></div>
								</div>
